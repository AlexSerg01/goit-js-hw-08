...
// слухач
galleryContainer.addEventListener("click", onGalletyItemClick);
//обробка кліку на елемент
function onGalletyItemClick(event) {
  event.preventDefault();
  const target = event.target;
  //перевірка чи натиснуте зображення
  if (target.nodeName !== "IMG") {
    return;
  }
  // отримуємо дані зображення з атрибуту data
